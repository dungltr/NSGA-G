 ...
 * </ol>
 */
public class NSGASNondominatedSorting extends NondominatedSorting{
	 ...
	 */
	public NSGASNondominatedSorting() {
	 ...
	 */
	public NSGASNondominatedSorting(DominanceComparator comparator) {
		super();
	...
	public void evaluate(Population population) {
		//System.out.println("Hello from NSGAVNondominatedSorting.java");
		...
		while (!remaining.isEmpty()) {
			...
			//updateCrowdingDistance(front);// Dung edit
			rank++;
		}
	}
