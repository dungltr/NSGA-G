 ...
 * </ol>
 */
public class NSGASFastNondominatedSorting extends NSGASNondominatedSorting {

	/**
	 * Constructs a fast non-dominated sorting operator using Pareto dominance.
	 */
	public NSGASFastNondominatedSorting() {
		super();
	}
	 ...
	 */
	public NSGASFastNondominatedSorting(DominanceComparator comparator) {
		super(comparator);
	}
	...
	public void evaluate(Population population) {
		...
		//System.out.println("hello from FastNondominatedSorting.java in NSGAS");
