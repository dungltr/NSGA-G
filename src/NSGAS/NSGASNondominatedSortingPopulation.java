 ...
 */
public class NSGASNondominatedSortingPopulation extends Population {
	 ...
	 */
	public NSGASNondominatedSortingPopulation(DominanceComparator comparator) {
		super();
		modified = false; //old is false

		if (Settings.useFastNondominatedSorting()) {
			nondominatedSorting = new NSGASFastNondominatedSorting(comparator);
			System.out.println("Using NSGASFastNondominatedSorting");
		} else {
			nondominatedSorting = new NSGASNondominatedSorting(comparator);
			//System.out.println("Using Original NSGASNondominatedSorting");
		}
	}
	 ...
	 * @param iterable the solutions used to initialize this population
	 */
	public NSGASNondominatedSortingPopulation(Iterable<? extends Solution> iterable) {
	...
	public void prune(int size) {
		...
		while (size() + front.size() > size) {
			...
			System.out.println("Hello from prune");
	 ...
	 */
	public void update() {
		modified = false; //old is false//Dung edit
		nondominatedSorting.evaluate(this);
		//FastNondominatedSorting(this);
	}
