...
public class covidProblemMultiDay extends AbstractProblem {
    ////// Parameter
    ...
    public covidProblemMultiDay(List<Double> initVariables, List<List<Double>> realFinalValues, List<Double> parameters,
    ...
    public void evaluate(Solution solution) {
        ...
        for (int i = 0; i < Variables.size(); i = i + (int) (1/this.step)){
            List<Double> tempEstimate = realValues(Variables.get(i));
